...
<div style="height: 100px;">
        <h1 style="text-align: center;color: rgb(85, 55, 21);"> WELCOME TO OUR LIBRARY MANAGEMENT SYSTEM</h1></div>
        <div class="container">
        <div class="vertical-center"><button style="border: 10%;border-color:rgb(88, 60, 17);background-color: rgb(231, 212, 192);" class="slogin"><a href="loginstudent.php">Login as a Student</a></button></div>
        <div class="vertical-center1"><button style="border: 10%;border-color:rgb(88, 60, 17);background-color: rgb(231, 212, 192);" class="slogin"><a href="loginadmin.php">Login as an Admin</a></button></div>
        </div>
